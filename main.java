...
public class main {
    ...
    customer1.isLoyalCustomer(true);
    ...
    customer2.isLoyalCustomer(false);
    ...
    store.updateStockAfterOrder(order1);
        ...
        System.out.println("Stock levels after the order: ");
        ...
        System.out.println("Order of John Smith: ");
        store.displayCustomersOrders(1);
    }
}
